package com.example.srv_twry.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTipValues() {
        ...
        tvBillTotalAmount.setText(getString(R.string.main_msg_billtotalamount, finalBillAmount));
    }
    ...
    @OnTextChanged(R.id.editBillAmount)
