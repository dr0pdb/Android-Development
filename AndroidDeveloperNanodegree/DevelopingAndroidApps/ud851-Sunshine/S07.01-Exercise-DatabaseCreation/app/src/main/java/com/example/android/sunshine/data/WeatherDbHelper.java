...
//  TODO (15) Override onCreate and create the weather table from within it
    ...
    public void onCreate(SQLiteDatabase db) {
        private static final String createDb = "CREATE TABLE "+WeatherContract.WeatherEntry.TABLE_NAME + " (" + WeatherContract.WeatherEntry._ID +" INTEGER PRIMARY KEY,"+ WeatherContract.WeatherEntry.COLUMN_DATE
        db.execSQL(createDb);
    }
