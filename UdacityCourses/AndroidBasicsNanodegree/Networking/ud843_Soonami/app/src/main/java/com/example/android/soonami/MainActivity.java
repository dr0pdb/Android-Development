    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG,"Problem in getting the Json response", e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200){
                    ...
                    Log.e(LOG_TAG,"url response code is "+ urlConnection.getResponseCode());
                }


            } catch (IOException e) {
                Log.e(LOG_TAG,"Problem while making the connection",e);
            } finally {
